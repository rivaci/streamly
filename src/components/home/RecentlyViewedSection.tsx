...
export function RecentlyViewedSection() {
  ...
  const { scrollRef, canLeft, canRight, scrollByPage } =
    useHorizontalScrollArrows<HTMLDivElement>();
  ...
  return (
    <section className="mt-10 first:mt-6">
      ...
      <div className="relative">
        ...
        <div
          ref={scrollRef}
          className="scrollbar-none -mx-1 flex gap-3 overflow-x-auto overscroll-x-contain px-1 pb-2 [-webkit-overflow-scrolling:touch] touch-pan-x"
        >
          {items.map((item) => (
            <Link
