...
/** Canonical origin for Open Graph / Twitter image URLs (see generate-metadata#metadatabase). */
function getMetadataBaseOrigin(): URL {
...
export const metadata: Metadata = {
  metadataBase: getMetadataBaseOrigin(),
  title: {
